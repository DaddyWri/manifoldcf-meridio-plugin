...
Instructions for Building Apache ManifoldCF Meridio Plugin from Source
--------------------------------------------------------------------------
...
Some Files Included In Apache ManifoldCF Meridio Plugin Distributions
-------------------------------------------------------------------------

dist/WebService
  The Apache ManifoldCF Meridio Plugin web service installation package.
dist/TestHarness
  The Apache ManifoldCF Meridio Plugin test package.

Licensing
---------

Apache ManifoldCF Meridio Plugin is licensed under the
...
may be subject to export controls on cryptographic software:
  ...
  The Apache ManifoldCF Meridio Plugin
